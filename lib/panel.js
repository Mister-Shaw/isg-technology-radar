...
export function panelCell(data,source,category,metric,period,chip='all'){
 ...
 const complete=established&&behaviorReviewed&&coverage.every(c=>c?.status==='complete')&&(metric!=='application'||source.application_reviewed!==false);
